...
env = environ.Env()
environ.Env.read_env(os.path.join(BASE_DIR, 'db', '.env'))
...
# SECRET_KEY = 'django-insecure-+fszl80oqncr!eyxnrnflny#s(!znf3jrpql=2jq$*x9q$h0ui'
...
ROOT_URLCONF = 'home_management_system.urls'
